 ...
 */
export declare const InsightContext: import("react").Context<{
...
export declare const InsightProvider: (props: InsightProviderProps) => import("react/jsx-runtime").JSX.Element;
export {};
